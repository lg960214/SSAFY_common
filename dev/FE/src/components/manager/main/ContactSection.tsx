    ...
    <>
      <div className="hidden sm:block">
        <div className="mx-auto h-[400px] w-[1520px] mt-5">
          ...
          <p className="font-Jeju text-5xl pt-24 text-center">
            지금 바로 <span className="font-Bungee">wait weight</span>을
            도입하여 체육관 운영을 혁신하세요!
          </p>
      ...
      <div className="block sm:hidden">
        <div className="bg-CustomOrange h-24 absolute bottom-0 flex justify-center items-center w-full">
          <p className="font-Jeju text-xl text-center">
            지금 바로 <span className="font-Bungee">wait weight</span>을
            도입하여
            <br />
            체육관 운영을 혁신하세요!
